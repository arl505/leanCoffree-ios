//
//  Originally Created by Kuray (FreakyCoder)
//  https://github.com/WrathChaos/StompClientLib
//
//  Modified by Alec Levin for specific SpringBoot WebSocket functionality
//    eg getting username in response header
//
...
struct StompCommands {
    ...
    static let responseHeaderSession = "user-name"
